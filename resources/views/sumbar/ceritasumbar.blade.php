                ...
                <form method="POST" action="">
                    ...
                    <div class="container-xxl py-5" id="services">
                        <div class="container px-lg-5">
                            <div class="row g-4">
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin1.jpg') }}" alt="">
                                ...
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                    ...
                                    menyayangi.
                                    <img class="img-fluid rounded w-100" src="{{ asset('img/malin3.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin4.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin5.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin6.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin7.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin8.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin9.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin10.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin11.jpg') }}" alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin12.jpg') }}"
                                    alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
                                ...
                                <img class="img-fluid rounded w-100" src="{{ asset('img/malin13.jpg') }}"
                                    alt="">
                                <p style="color: black; margin-bottom: 5px; margin-top: 5px">
